...
export const ProfilePage = () => {
  ...
  const pokemonFilter = (pokemonName: string) => {
    ...
    const updatedPokemons = currentPokemons.filter((pokemon) => pokemon.name !== pokemonName);
  ...
  return (
    <div className="page">
      ...
      <div className={clsx('card', styles['pokemons-team__wrapper'])}>
        <Typography variant="title-regular">Ваша команда: {user.pokemons?.length}</Typography>
